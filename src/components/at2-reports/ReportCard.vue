...
interface Props {
  ...
  loadingText?: string
  errorText?: string
  colorScheme?: 'navy' | 'institutional-green' | 'institutional-blue' | 'blue' | 'green' | 'purple' | 'yellow' | 'red' | 'indigo'
}
...
const iconBgClass = computed(() => {
  const colors = {
    ...
    'institutional-green': 'bg-emerald-100 text-emerald-800',
    'institutional-blue': 'bg-blue-100 text-blue-800',
...
const valueColorClass = computed(() => {
  const colors = {
    navy: 'text-slate-800',
    'institutional-green': 'text-emerald-800',
    'institutional-blue': 'text-blue-800',
    blue: 'text-blue-600',
...
const iconPath = computed(() => {
  const icons = {
    navy: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4',
    'institutional-green': 'M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2 2z M8 5a2 2 0 012-2h2a2 2 0 012 2v0M9 12l2 2 4-4',
    'institutional-blue': 'M9 12l2 2 4-4m6 2a2 2 0 11-4 0 2 2 0 014 0zm-6 4a2 2 0 11-4 0 2 2 0 014 0zm-6-4a2 2 0 11-4 0 2 2 0 014 0zm2-4a2 2 0 11-4 0 2 2 0 014 0zm8 8a2 2 0 11-4 0 2 2 0 014 0z',
  ...
  return icons[props.colorScheme] || icons.navy
})

const buttonClass = computed(() => {
  const colors = {
    navy: 'bg-slate-800',
    'institutional-green': 'bg-emerald-800',
    'institutional-blue': 'bg-blue-800',
    blue: 'bg-blue-600',
    green: 'bg-green-600',
